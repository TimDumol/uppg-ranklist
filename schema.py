...
ranks = Table('ranks', metadata,
    Column(u'id', INTEGER(), primary_key=True, nullable=False),
            Column(u'name', VARCHAR(length=64), primary_key=False,
                   nullable=False),
            ...
            Column(u'codeforces_id', VARCHAR(length=64), primary_key=False),
            Column(u'codeforces_rating', INTEGER(), primary_key=False),
    )

Index(u'euler_id', ranks.c.euler_id, unique=True)
Index(u'uva_id', ranks.c.uva_id, unique=True)
Index(u'codeforces_id', ranks.c.codeforces_id, unique=True)
